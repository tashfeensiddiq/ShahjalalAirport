...
public class MoneyExchangeActivity extends AppCompatActivity implements OnMapReadyCallback {
...
//YOU Can change this type at your own will, e.g hospital, cafe, restaurant.... and see how it all works
    ...
    private void parseLocationResult(JSONObject result) {
        ...
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                Toast.makeText(this, jsonArray.length() + " Bank found!",

                        Toast.LENGTH_LONG).show();
            } else if (result.getString(STATUS).equalsIgnoreCase(ZERO_RESULTS)) {
                Toast.makeText(this, "No Bank found in 5KM radius!!!",
    ...
    public void onBackPressed() {
        startActivity(new Intent(MoneyExchangeActivity.this, MainActivity.class));
