...
public class PoliceActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void parseLocationResult(JSONObject result) {
        ...
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                Toast.makeText(this, jsonArray.length() + " Police found!",

                        Toast.LENGTH_LONG).show();
            } else if (result.getString(STATUS).equalsIgnoreCase(ZERO_RESULTS)) {
                Toast.makeText(this, "No Police found in 5KM radius!!!",
